export const doms = {
	 ...
	 */
	mainHome: document.querySelector('.topNav .mainHome'),
	/**
	 * app
	 * @type {HTMLLIElement} app - app
	 */
	app: document.querySelector('.topNav .app'),
	/**
	 * fileBook
	 * @type {HTMLLIElement} fileBook - fileBook
	 */
	folders: document.querySelector('.topNav .folders'),
	/**
	 * file
	 * @type {HTMLLIElement} file - file
	 */
	file: document.querySelector('.topNav .file'),
	/**
	 * highContrast
	 * @type {HTMLLIElement} highContrast - highContrast
	 */
	highContrast: document.querySelector('.topNav .highContrast'),
	/**
	 * company
	 * @type {HTMLLIElement} company - company
	 */
	company: document.querySelector('.centerNav .company'),
	/**
	 * software
	 * @type {HTMLLIElement} software - software
	 */
	software: document.querySelector('.centerNav .software'),
	/**
	 * sum
